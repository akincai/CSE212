...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue pushes new entries at the start of the list; Dequeue removes from the start as well
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: No conditional statement for Turns being less than 1 (infinite turns) and allowing for the person to enqueue without decrementing turns
